<template>
  <view class="container">
    ...
    <!-- 底部导航（只出现一次！） -->
    <view class="tabbar">
      <view class="tabbar-item" @click="goPage('/pages/index/index')">
        <view class="tabbar-icon">🏠</view>
        <view class="tabbar-text">项目广场</view>
      </view>
      <view class="tabbar-item active">
        <view class="tabbar-icon">🏢</view>
        <view class="tabbar-text">公共社区</view>
      </view>
      <view class="tabbar-center" @click="onPublish">
        <view class="center-icon">+</view>
      </view>
      <view class="tabbar-item" @click="goPage('/pages/message/message')">
        <view class="tabbar-icon">✉️</view>
        <view class="tabbar-text">消息</view>
      </view>
      <view class="tabbar-item" @click="goPage('/pages/settings/settings')">
        <view class="tabbar-icon">👤</view>
        <view class="tabbar-text">个人中心</view>
      </view>
    </view>
